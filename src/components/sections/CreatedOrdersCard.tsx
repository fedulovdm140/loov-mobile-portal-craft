      ...
      <div className="flex items-center gap-2">
        <div className="relative w-8 h-8 flex-shrink-0">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-[10px] font-bold text-gray-700">{rate}%</span>
          </div>
        </div>
  ...
  return (
    <Card className="bg-gradient-to-br from-white to-gray-50/30 shadow-lg border-0 ring-1 ring-gray-200/60">
      ...
      <CardContent className="space-y-3 px-4 pt-0 pb-4">
        ...
        <div className="bg-gradient-to-r from-red-50 to-red-100/50 rounded-xl p-3 border border-red-200/50 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-xs font-bold text-red-800 uppercase tracking-wide">Не закрытые сделки</div>
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50/50 rounded-xl p-3 border border-green-200/50 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="text-right">
              ...
              <div className="text-xs text-green-600 font-medium">из {dailyTarget.toLocaleString('ru-RU')} ₽</div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {/* Conversions */}
          <div className="bg-gradient-to-br from-orange-50 to-amber-50/50 rounded-xl p-3 border border-orange-200/50 shadow-sm">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50/50 rounded-xl p-3 border border-blue-200/50 shadow-sm">
            ...
            <div className="space-y-1">
              {opticsData.map((item, index) => (
                <div key={index} className="flex justify-between items-center">
                  <div className="flex items-center gap-1.5">
                    <span className="text-xs font-bold text-blue-700 w-3 text-center bg-blue-100 rounded px-1">{item.quantity}</span>
              ...
              <div className="flex justify-between items-center pt-1 border-t border-blue-200/50">
                <div className="flex items-center gap-1.5">
                  <span className="text-xs font-bold text-blue-800 w-3 text-center bg-blue-200 rounded px-1">{opticsData.reduce((sum, item) => sum + item.quantity, 0)}</span>
