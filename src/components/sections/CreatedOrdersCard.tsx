        ...
        <div className="space-y-2">
          ...
          <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-lg p-3">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="text-xs h-8 text-gray-600">Категория</TableHead>
                  <TableHead className="text-xs h-8 text-gray-600 text-center">Кол-во</TableHead>
                  <TableHead className="text-xs h-8 text-gray-600 text-right">Сумма</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                ...
                <TableRow className="border-emerald-200 bg-emerald-100/50">
                  ...
                  <TableCell className="text-xs py-2 text-right font-bold text-emerald-700">
