      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-gray-700">Прогноз выполнения плана на месяц</span>
          </div>
          ...
          <div className="p-4 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl">
            <div className="flex justify-between items-center">
              ...
              <span className={`text-2xl font-bold ${monthlyForecast >= 100 ? 'text-green-600' : monthlyForecast >= 80 ? 'text-blue-600' : 'text-orange-600'}`}>
                {monthlyForecast}%
              </span>
            </div>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <div className="text-center">
              <span className={`text-sm font-bold ${monthlyProgress >= 100 ? 'text-green-600' : monthlyProgress >= 80 ? 'text-indigo-600' : 'text-orange-600'}`}>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <div className="text-center">
              <span className={`text-sm font-bold ${dailyProgress >= 100 ? 'text-green-600' : dailyProgress >= 80 ? 'text-blue-600' : 'text-orange-600'}`}>
