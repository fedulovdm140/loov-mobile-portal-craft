      ...
      <CardContent className="space-y-5">
        ...
        <div className="space-y-2">
          <div className="p-3 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl">
            <div className="flex justify-between items-center">
              <span className="text-sm font-semibold text-gray-700">Прогнозное выполнение плана</span>
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <div className="relative h-2 bg-gray-100 rounded-full overflow-hidden">
              <div className="absolute top-0 left-0 h-full bg-gradient-to-r from-indigo-400 to-indigo-600 rounded-full transition-all duration-500" style={{
              width: `${Math.min(monthlyProgress, 100)}%`
            }} />
              {monthlyProgress > 100 && <div className="absolute top-0 left-0 h-full bg-gradient-to-r from-green-400 to-green-600 rounded-full" style={{
              width: '100%'
            }} />}
            </div>
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <div className="relative h-2 bg-gray-100 rounded-full overflow-hidden">
              <div className="absolute top-0 left-0 h-full bg-gradient-to-r from-blue-400 to-blue-600 rounded-full transition-all duration-500" style={{
              width: `${Math.min(dailyProgress, 100)}%`
            }} />
              {dailyProgress > 100 && <div className="absolute top-0 left-0 h-full bg-gradient-to-r from-green-400 to-green-600 rounded-full" style={{
              width: '100%'
            }} />}
            </div>
            <div className="text-center">
